...
from lib.ant import ant_colony_optimization, useTACO

dataset_dir = r'dataset\captured'
augmented_dir = r'dataset\augmented'
segmented_dir = r'dataset\segmented'
...
for class_folder in os.listdir(dataset_dir):
    ...
    for image_file in os.listdir(class_path):
        ...
        segmented_image = os.path.join(segmented_dir, class_label)
        segmented_image = os.path.join(segmented_image, image_file)
        # if not os.path.exists(segmented_image):
        cv2.imwrite(segmented_image, image)
